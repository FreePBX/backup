			...
			<div class="fpbx-container">
				<div class="display no-border">
					<ul class="nav nav-tabs">
						<li role="presentation"><a href="?display=backup">
								<?php echo _("Backup")?></a></li>
						<li role="presentation" class='active'><a href="?display=backup_restore">
								<?php echo _("Restore")?></a></li>
