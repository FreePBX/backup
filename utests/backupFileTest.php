...
class fooAddTest extends PHPUnit_Framework_TestCase{
    public static function setUpBeforeClass(){
        ...
        $phar = new PharData('/tmp/20180501-155236-1525215156-15.0.1alpha2-2097601499.tar');
        $phar->setMetadata(json_decode(base64_decode($metadata),true));
        $phar->addEmptyDir('/tmp/');
        $phar->compress(Phar::GZ);
        unset($phar);
        rename('/tmp/20180501-155236-1525215156-15.tar.gz', '/tmp/20180501-155236-1525215156-15.0.1alpha2-2097601499.tar.gz');
    ...
    public function testMetaData(){
        ...
        $this->assertEquals(1525215156,$data['date']);
