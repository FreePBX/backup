...
<div class="section" data-id="backup-warmspare">
    ...
    <div class="row">
      <div class="form-group">
        ...
        <div class="col-md-9 radioset">
          <input type="radio" name="warmspareenables" id="warmspareenablesyes" value="yes" <?php echo ($warmspareenables=="yes" ?
            "CHECKED": "") ?>>
  ...
  <div class="element-container warmspare">
    <div class="row">
      <div class="form-group">
        <div class="col-md-3">
          <label class="control-label" for="warmspare_type">
            <?php echo _("Server Type") ?>
          </label>
          <i class="fa fa-question-circle fpbx-help-icon" data-for="warmspare_type"></i>
        </div>
        <div class="col-md-9 radioset">
          <input type="radio" name="warmspare_type" id="warmspare_typeprimary" value="primary" <?php echo ($warmspare_type=="primary"
            ? "CHECKED": "") ?>>
          <label for="warmspare_typeprimary">
            <?php echo _("Primary");?>
          </label>
          <input type="radio" name="warmspare_type" id="warmspare_typespare" value="spare" <?php echo ($warmspare_type=="spare" ?
            "CHECKED": "") ?>>
          <label for="warmspare_typespare">
            <?php echo _("Spare");?>
          </label>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <span id="warmspare_type-help" class="help-block fpbx-help-block">
          <?php echo _("Is this the server that will be sending data (Primary) or receiving data (Spare)")?>
        </span>
      </div>
    </div>
  </div>
  ...
  <div class="element-container warmspare">
    <div class="row">
      <div class="form-group">
        <div class="col-md-3">
          <label class="control-label" for="warmspare_remote">
            <?php echo _("Enable Remote Trunks") ?>
          </label>
          <i class="fa fa-question-circle fpbx-help-icon" data-for="warmspare_remote"></i>
        </div>
        <div class="col-md-9 radioset">
          <input type="radio" name="warmspare_remote" id="warmspare_remoteyes" value="yes" <?php echo ($warmspare_remote=="yes" ?
            "CHECKED": "") ?>>
          <label for="warmspare_remoteyes">
            <?php echo _("Yes");?>
          </label>
          <input type="radio" name="warmspare_remote" id="warmspare_remoteno" <?php echo ($warmspare_remote=="yes" ? "": "CHECKED")
            ?>>
          <label for="warmspare_remoteno">
            <?php echo _("No");?>
          </label>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <span id="warmspare_remote-help" class="help-block fpbx-help-block">
  ...
  <div class="element-container warmspare">
    <div class="row">
      <div class="form-group">
        <div class="col-md-3">
          <label class="control-label" for="publickey">
            <?php echo _("Server Public Key") ?>
          </label>
          <i class="fa fa-question-circle fpbx-help-icon" data-for="publickey"></i>
        </div>
        <div class="col-md-9">
          <textarea class="form-control" id="publickey" rows="8" name="publickey" <?php echo ($warmspare_type=='primary' )?
            'readonly': ''?>>
            <?php echo $publickey?>
          </textarea>
          <?php 
    ...
    <div class="row">
      <div class="col-md-12">
        <span id="publickey-help" class="help-block fpbx-help-block">
          <?php echo _("This is the servers public key.")?>
        </span>
      </div>
    </div>
  </div>
