...
<table id="backup-side" data-escape="true" data-url="ajax.php?module=backup&command=backupGrid" data-cache="false" data-toolbar="#toolbar-all" data-toggle="table" data-search="true" class="table">
	<thead>
		<tr>
