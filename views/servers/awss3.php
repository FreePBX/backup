...
<form class="fpbx-submit" action="" method="post" id="server_form" name="server_form" data-fpbx-delete="?display=backup_servers&action=delete&id=<?php echo isset($request['id']) ? $request['id'] : '' ?>">
