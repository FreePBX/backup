...
<table id="templatesGrid" data-escape="true" data-toolbar="#toolbar-templates" data-pagination="true" data-search="true" data-url="ajax.php?module=backup&command=getJSON&jdata=templateGrid" data-cache="false" data-toggle="table" class="table table-striped">
  <thead>
    <tr>
